...
function mslsmenu_admin_register( $page ) {
	...
	add_settings_field( 'mslsmenu_theme_location', __( 'Theme Location' ), 'mslsmenu_theme_location', $page, 'mslsmenu_section', $args );
	add_settings_field( 'mslsmenu_display', __( 'Display' ), 'mslsmenu_display', $page, 'mslsmenu_section', $args );
